...
class ModuleDto(BaseModel):
    ...
    classroom_id: str = Field(..., alias="classroomId", validation_alias="classroom_id")
    name: str = Field(..., alias="name")
    category: Optional[str] = Field(None, alias="category")
    prerequisite_module_id: Optional[str] = Field(None, alias="prerequisiteModuleId", validation_alias="prerequisite_module_id")
